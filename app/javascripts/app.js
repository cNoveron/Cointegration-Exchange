...
window.App = {
    ...
    printImportantInformation: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            ...
            divAddress.appendChild(
                document.createTextNode("Address Exchange: " + instance.address)
            )
        ...
        TokenContract.deployed().then(function (instance) {
            var divAddress = document.createElement("div")
            divAddress.appendChild(
                document.createTextNode("Address Token: " + instance.address)
            )
            divAddress.setAttribute("class", "alert alert-info")
            document.getElementById("importantInformation").appendChild(divAddress)
        });
    ...
    refreshBalanceExchange: function () {
        ...
        .then(function (exchangeInstance) {
            console.log("ExchangeContract.deployed()",value)
            return exchangeInstance.getBalance("FIXED", {from: account});
        }).then(function (value) {            
            console.log("exchangeInstance.getBalance(\"FIXED\", {from: account})",value)
    ...
    depositEther: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            ...
            console.log(e);
            self.setStatus("depositEther: Error getting balance; see log.");
        });
    },
    withdrawEther: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            ...
            console.log(e);
            self.setStatus("withdrawEther: Error getting balance; see log.");
        });
    },
    depositToken: function () {
        ...
        ExchangeContract.deployed().then(function (exchangeInstance) {
            ...
            console.log(e);
            self.setStatus("depositToken: Error getting balance; see log.");
        });
    },
    ...
    withdrawToken: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            ...
            console.log(e);
            App.setStatus("withdrawToken: Error getting balance; see log.");
        });
    },
    /**
    ...
    updateOrderBooks: function () {
        ...
        ExchangeContract.deployed().then(function(instance) {
            ...
            console.log(e);
            App.setStatus("updateOrderBooks: Error getting balance; see log.");
        });
    },
...
//listen to trading events
        ...
        ExchangeContract.deployed().then(function (instance) {
            ...
            console.log(e);
            App.setStatus("listenToTradingEvents: Error getting balance; see log.");
        });
    },
    sellToken: function () {
        //sell token
        ...
        ExchangeContract.deployed().then(function(instance) {
            ...
            console.log(e);
            App.setStatus("sellToken: Error; see log.");
        });
    },
    buyToken: function () {
        ...
        ExchangeContract.deployed().then(function(instance) {
            ...
            console.log(e);
            App.setStatus("buyToken: Error; see log.");
        });
    },
    ...
    updateTokenBalance: function () {
        ...
        TokenContract.deployed().then(function (instance) {
            ...
            console.log(e);
            App.setStatus("updateTokenBalance: Error getting balance; see log.");
        });
    },
    watchTokenEvents: function () {
        ...
        TokenContract.deployed().then(function (instance) {
            ...
            console.log(e);
            App.setStatus("watchTokenEvents: Error getting balance; see log.");
        });
    },
    ...
    addTokenToExchange: function () {
        ...
        ExchangeContract.deployed().then(function (instance) {
            ...
            console.log(e);
            App.setStatus("addTokenToExchange: Error getting balance; see log.");
        });
    },
